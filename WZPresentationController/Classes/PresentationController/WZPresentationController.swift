...
open class WZPresentationController: UIPresentationController {
    ...
    @objc required public init(presentedViewController presented: UIViewController, presentingViewController presenting: UIViewController? = nil, maskViewClass:WZPresentationMaskView.Type = WZPresentationMaskView.self, effect:UIBlurEffect? = nil) {
    ...
    {
        guard let transitioning = presentedViewController as? WZPresentationTransitioning, let `containerView` = containerView else {
